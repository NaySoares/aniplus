import cover01 from "../assets/imgs/1.jpg";
import cover02 from "../assets/imgs/2.jpg";
import cover03 from "../assets/imgs/3.png";
import cover04 from "../assets/imgs/4.jpg";
import cover05 from "../assets/imgs/5.png";
import cover06 from "../assets/imgs/6.jpg";
import cover07 from "../assets/imgs/7.png";
import cover08 from "../assets/imgs/8.jpg";
import cover09 from "../assets/imgs/9.jpg";
import cover10 from "../assets/imgs/10.jpg";
...
export const dataAnimes = [
  ...
  },
  {
    ...
    "description": "The third season of Yahari Ore no Seishun Love Come wa Machigatteiru. As the members of the Service Club band together to host a school prom, Hachiman, Yukino and Yui will have to put their feelings into words and truly learn to understand each other at long last… if the Service Club can even stay afloat, that is!",
    "cover": cover05,
    "season": "Summer 2020"
  },
  {
